...
class RSpec::Mocks::AndInvokeImplementation
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:777
...
class RSpec::Mocks::AndReturnImplementation
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:761
...
class RSpec::Mocks::AndWrapOriginalImplementation
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:843
  def call(*args, **_arg1, &block); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:823
  def initial_action=(_value); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:839
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:831
  def terminal_action=(_value); end

  private

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:850
  def cannot_modify_further_error; end
end

# pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:821
...
class RSpec::Mocks::AndYieldImplementation
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:736
...
class RSpec::Mocks::AnyInstance::Recorder
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/any_instance/recorder.rb:235
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/any_instance/recorder.rb:183
  def received_expected_message!(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/any_instance/recorder.rb:229
  def remove_dummy_method!(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/any_instance/recorder.rb:189
  def restore_method!(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/any_instance/recorder.rb:197
...
module RSpec::Mocks::ArgumentMatchers
  ...
  #   expect(object).to receive(:message).with(array_excluding([1,2,3]))
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:100
  ...
  #   expect(object).to receive(:message).with(array_including([1,2,3]))
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:90
  ...
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:121
  ...
  class << self
    # @private
    #
    # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:128
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:159
class RSpec::Mocks::ArgumentMatchers::AnyArgMatcher < ::RSpec::Mocks::ArgumentMatchers::SingletonMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:164
  def description; end
end

# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:147
RSpec::Mocks::ArgumentMatchers::AnyArgMatcher::INSTANCE = T.let(T.unsafe(nil), RSpec::Mocks::ArgumentMatchers::AnyArgMatcher)

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:152
class RSpec::Mocks::ArgumentMatchers::AnyArgsMatcher < ::RSpec::Mocks::ArgumentMatchers::SingletonMatcher
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:153
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::ArrayExcludingMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:279
  def ===(actual); end
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:298
...
class RSpec::Mocks::ArgumentMatchers::ArrayIncludingMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:247
  def ===(actual); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:260
  def description; end

  private

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:266
...
class RSpec::Mocks::ArgumentMatchers::BaseHashMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:193
  def ===(predicate, actual); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:201
  def description(name); end

  private

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:207
  def formatted_expected_hash; end
end

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:177
class RSpec::Mocks::ArgumentMatchers::BooleanMatcher < ::RSpec::Mocks::ArgumentMatchers::SingletonMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:182
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::DuckTypeMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:311
  def ===(value); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:315
  def description; end
end

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:231
class RSpec::Mocks::ArgumentMatchers::HashExcludingMatcher < ::RSpec::Mocks::ArgumentMatchers::BaseHashMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:236
  def description; end
end

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:220
class RSpec::Mocks::ArgumentMatchers::HashIncludingMatcher < ::RSpec::Mocks::ArgumentMatchers::BaseHashMatcher
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:225
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::InstanceOf
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:326
  def ===(actual); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:330
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::KindOf
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:341
  def ===(actual); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:345
  def description; end
end

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:170
class RSpec::Mocks::ArgumentMatchers::NoArgsMatcher < ::RSpec::Mocks::ArgumentMatchers::SingletonMatcher
  # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:171
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::SingletonMatcher
  class << self
    ...
    # pkg:gem/rspec-mocks#lib/rspec/mocks/argument_matchers.rb:144
    def new(*_arg0); end
  end
end
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:121
...
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:135
...
class RSpec::Mocks::Implementation
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:808
  def actions; end
end
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:73
class RSpec::Mocks::InstanceVerifyingDouble
  include ::RSpec::Mocks::TestDouble
  include ::RSpec::Mocks::VerifyingDouble

  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:77
...
module RSpec::Mocks::MessageExpectation::ImplementationDetails
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:589
  def additional_expected_calls; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:546
  def advise(*args); end
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:578
  def description_for(verb); end
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:572
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:606
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:585
  def raise_out_of_order_error; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:568
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:542
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:550
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:689
  def initial_implementation_action=(action); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:693
  def inner_implementation_action=(action); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:633
  def invoke_incrementing_actual_calls_by(increment, allowed_to_fail, parent_stub, *args, **_arg4, &block); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:618
  def invoking_internals; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:622
  def invoking_internals=(value); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:670
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:699
  def terminal_implementation_action=(action); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:703
  def warn_about_stub_override; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/message_expectation.rb:710
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:112
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:89
module RSpec::Mocks::ObjectVerifyingDoubleMethods
  include ::RSpec::Mocks::TestDouble
  include ::RSpec::Mocks::VerifyingDouble

  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:93
  def as_stubbed_const(options = T.unsafe(nil)); end

  private

  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:100
  def __build_mock_proxy(order_group); end
end
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:456
...
module RSpec::Mocks::PartialClassDoubleProxyMethods
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:381
  ...
  # does.
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:406
  def original_method_handle_for(message); end

  protected

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:434
  def method_double_from_ancestor_for(message); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:429
  def original_unbound_method_handle_from_ancestor_for(message); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:444
  def superclass_proxy; end
end

# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:317
class RSpec::Mocks::PartialDoubleProxy < ::RSpec::Mocks::Proxy
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:331
  def add_simple_expectation(method_name, response, location); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:337
  def add_simple_stub(method_name, response); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:354
  def message_received(message, *args, **_arg2, &block); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:318
  def original_method_handle_for(message); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:349
  def reset; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:343
...
class RSpec::Mocks::Proxy
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:79
  def add_simple_expectation(method_name, response, location); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:140
  def add_simple_stub(method_name, response); end
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:84
  def build_expectation(method_name); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:117
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:15
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:195
  def message_received(message, *args, **_arg2, &block); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:174
  def messages_arg_list; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:260
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:42
  def object; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:58
  def original_method_handle_for(_message); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:254
  def prepended_modules_of_singleton_class; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:233
  def raise_missing_default_stub_error(expectation, args_for_multiple_calls); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:228
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:186
  def record_message_received(message, *args, **_arg2, &block); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:145
  def remove_stub(method_name); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:150
  def remove_stub_if_present(method_name); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:94
  def replay_received_message_on(expectation, &block); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:160
  def reset; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:155
  def verify; end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:238
  def visibility_for(_method_name); end

  private

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:277
  def find_almost_matching_expectation(method_name, *args, **_arg2); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:301
  def find_almost_matching_stub(method_name, *args, **_arg2); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:284
  def find_best_matching_expectation_for(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:270
  def find_matching_expectation(method_name, *args, **_arg2); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:296
  def find_matching_method_stub(method_name, *args, **_arg2); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:266
  def method_double_for(message); end

  class << self
    # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:244
    def prepended_modules_of(klass); end
  end
end

# pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:62
...
class RSpec::Mocks::ProxyForNil < ::RSpec::Mocks::PartialDoubleProxy
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:512
  def raise_error(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:482
  def set_expectation_behavior; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:507
  def warn(method_name); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:496
...
module RSpec::Mocks::TestDouble
  ...
  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:58
  def __build_mock_proxy_unless_expired(order_group); end

  # @private
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:63
  ...
  # doubles.
  #
  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:69
  def freeze; end
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:118
  def __build_mock_proxy(order_group); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:114
  def __mock_proxy; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:122
  def __raise_expired_error; end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:108
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:140
module RSpec::Mocks::TestDoubleFormatter
  class << self
    # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:141
    def format(dbl, unwrap = T.unsafe(nil)); end

    private

    # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:167
    def name_desc(dbl); end

    # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:150
    def type_desc(dbl); end

    # pkg:gem/rspec-mocks#lib/rspec/mocks/test_double.rb:162
...
# @private
#
# pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:308
class RSpec::Mocks::TestDoubleProxy < ::RSpec::Mocks::Proxy
  # pkg:gem/rspec-mocks#lib/rspec/mocks/proxy.rb:309
  def reset; end
end
...
module RSpec::Mocks::VerifyingDouble
  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:55
  def initialize(doubled_module, *args); end

  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:40
  ...
  # pkg:gem/rspec-mocks#lib/rspec/mocks/verifying_double.rb:50
