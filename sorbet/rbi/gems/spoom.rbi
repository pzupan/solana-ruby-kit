...
module Spoom
  ...
  def self.parse_ruby_with_comments(ruby, file:); end
end
...
class Spoom::Sorbet::Assertions
  def self.collect_assigns(ruby_contents, file:); end
  def self.dedent_value(assign); end
  def self.rbi_to_rbs(ruby_contents, file:); end
end
...
class Spoom::Sorbet::Sigs
  def self.collect_rbs_comments(ruby_contents); end
  def self.collect_sorbet_sigs(ruby_contents); end
  def self.rbi_to_rbs(ruby_contents, positional_names: nil); end
  def self.rbs_to_rbi(ruby_contents); end
  def self.strip(ruby_contents); end
end
class Spoom::Sorbet::Sigs::Error < Spoom::Error
end
...
class Spoom::Sorbet::Sigs::RBIToRBSTranslator
  def self.translate(sig, node, positional_names: nil); end
  def self.translate_attr_sig(sig, node, positional_names: nil); end
  def self.translate_method_sig(sig, node, positional_names: nil); end
end
class Spoom::Sorbet::Sigs::RBSToRBITranslator
  def self.translate(comment, node); end
  def self.translate_attr_sig(comment, node); end
  def self.translate_method_sig(rbs_comment, node); end
end
