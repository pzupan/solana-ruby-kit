...
module RbNaCl::Util
  ...
  def self.check_hmac_key(string, description); end
...
class RbNaCl::Signatures::Ed25519::SigningKey
  ...
  def crypto_sign_ed25519_sk_to_curve25519(*arg0); end
...
class RbNaCl::Signatures::Ed25519::VerifyKey
  ...
  def crypto_sign_ed25519_pk_to_curve25519(*arg0); end
  def initialize(key); end
  def primitive; end
  def self.crypto_sign_ed25519_open(*arg0); end
  def self.crypto_sign_ed25519_pk_to_curve25519(*arg0); end
  def self.sign_ed25519_open(*args); end
  def self.signature_bytes; end
  def self.to_public_key(*args); end
  def signature_bytes; end
  def to_bytes; end
...
module RbNaCl::PasswordHash
  ...
  def self.scrypt(password, salt, opslimit = nil, memlimit = nil, digest_size = nil); end
end
class RbNaCl::PasswordHash::SCrypt
  def crypto_pwhash_scryptsalsa208sha256(*arg0); end
  def crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive(*arg0); end
  def crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive(*arg0); end
  ...
  def self.crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive(*arg0); end
  def self.crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive(*arg0); end
...
class RbNaCl::HMAC::SHA256::SHA256State < FFI::Struct
end
class RbNaCl::HMAC::SHA256::State < FFI::Struct
end
...
class RbNaCl::HMAC::SHA512256::SHA512256State < FFI::Struct
end
class RbNaCl::HMAC::SHA512256::State < FFI::Struct
end
...
class RbNaCl::HMAC::SHA512::SHA512State < FFI::Struct
end
class RbNaCl::HMAC::SHA512::State < FFI::Struct
end
